    ...
    <div className="max-w-3xl mx-auto animate-fade-in">
      <header className="mb-20">
        ...
        <p className="font-sans text-stone-500 font-light leading-relaxed text-lg max-w-2xl">
          My work focuses on <span className="text-gold-600 font-normal">Human-Computer Interaction</span> and Cognitive Science. 
      ...
      <div className="space-y-20">
        {papers.map((paper) => (
          <article key={paper.id} className="group relative pl-0 md:pl-8 border-l border-transparent hover:border-gold-500/30 transition-colors duration-500">
            ...
            <div className="mb-2 font-sans text-xs uppercase tracking-widest text-gold-600/80">
              {paper.year}
            </div>
            
            <h3 className="font-serif text-3xl text-charcoal group-hover:text-gold-600 transition-colors duration-300">
            ...
            <div className="mt-6 pt-2">
               <button className="flex items-center gap-2 text-[10px] font-sans uppercase tracking-[0.2em] text-stone-400 hover:text-gold-600 transition-colors">
      ...
      <div className="mt-32 pt-12 border-t border-stone-200/60 text-center">
        <p className="font-serif text-stone-400 italic text-lg">
          View full bibliography on <a href="#" className="text-gold-600 underline decoration-gold-200 hover:decoration-gold-600 underline-offset-4 transition-all">Google Scholar</a>.
        </p>
      </div>
    </div>
  );
