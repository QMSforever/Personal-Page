    ...
    <div className="h-full flex flex-col justify-center max-w-3xl mx-auto animate-fade-in py-12">
      <div className="space-y-12">
        <div className="flex items-center gap-4">
            ...
            <p className="font-sans text-xs uppercase tracking-[0.25em] text-gold-600">Introduction</p>
        </div>
        ...
        <div className="font-serif text-2xl text-stone-500 leading-relaxed space-y-8 max-w-2xl">
          <p>
            Currently pursuing my Ph.D., I explore the subtle nuances of <span className="text-charcoal/80 underline decoration-gold-500/40 decoration-1 underline-offset-4">human-computer interaction</span>, focusing on how digital environments shape our perception of reality.
          </p>
          <p className="text-xl">
        ...
        <div className="pt-12">
          <div className="relative inline-block">
              ...
              <div className="absolute -right-4 -bottom-4 w-24 h-24 bg-paper border-l border-t border-stone-300 hidden md:flex items-center justify-center">
                  <span className="font-serif italic text-gold-600 text-lg">Est. 2024</span>
              </div>
          </div>
