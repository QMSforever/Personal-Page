  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in">
      <header className="mb-20 flex items-end gap-6">
        ...
        <p className="font-sans text-gold-600/60 font-medium text-xs uppercase tracking-widest pb-6">
          Thoughts & Notes
        </p>
      </header>
      ...
      <div className="space-y-4">
        {posts.map((post) => (
          <div key={post.id} className="group py-10 border-b border-stone-200/50 hover:border-gold-500/30 transition-colors duration-500 cursor-pointer">
            <div className="flex flex-col md:flex-row gap-2 md:gap-12 items-baseline">
              <span className="font-sans text-[11px] text-gold-600/70 font-medium uppercase tracking-widest w-24 shrink-0">
                {post.date}
              </span>
              <div className="flex-1">
                <h3 className="font-serif text-3xl text-charcoal mb-3 group-hover:text-gold-700 transition-colors duration-300">
                  {post.title}
                </h3>
                <p className="font-serif text-stone-500 text-xl leading-relaxed mb-4 opacity-80 group-hover:opacity-100">
                  {post.excerpt}
                </p>
                <span className="font-sans text-[10px] text-gold-500 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0">
                   Read Entry &rarr;
                </span>
              </div>
            </div>
