        ...
        {posts.map((post) => (
          <div key={post.id} className="group py-10 border-b border-stone-200/40 hover:border-gold-500/30 transition-colors duration-500 cursor-pointer">
            <div className="flex flex-col md:flex-row gap-3 md:gap-12 items-baseline">
              <span className="font-helvetica text-xs text-academic-red font-semibold uppercase tracking-widest w-28 shrink-0 pt-1">
                {post.date}
              </span>
              <div className="flex-1">
                ...
                <p className="font-helvetica text-stone-500 text-lg md:text-xl leading-relaxed mb-5 opacity-90 group-hover:opacity-100 max-w-2xl">
                  {post.excerpt}
                </p>
                <span className="font-helvetica text-[11px] text-gold-500 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0 font-bold flex items-center gap-2">
